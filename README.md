...
Picture Book - Мултимедијална сликовница со големи слики, звуци и вибрации
Number Games - Игри со аудио читање и интерактивен фидбек
Camera Recognition - Распознавање на валути, бои и објекти преку камера
Spatial Orientation - Просторна ориентација со аудио инструкции
Sound Identification - Идентификација на звуци со гласовен/текстуален внес
Braille Learning - Интерактивни вежби за учење на Брајова азбука (A-Z)
Cyber Safety - Сајбер безбедност квизови со гласовни инструкции
Sound Memory - Игра на звуци
Voice Pong - Аудио базирана Понг игра
...
Како да се стартува
Предуслови
Инсталирај Flutter SDK (3.0.0 или повисоко)
